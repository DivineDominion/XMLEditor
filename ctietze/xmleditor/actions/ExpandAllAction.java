 ...
 */
public class ExpandAllAction extends AbstractEditMenuAction {
	
	private static final String ACTION_NAME = Resources.getString("gui.menu.edit.expand_all");

	public ExpandAllAction(EditorWindow editor) {
	...
	public void actionPerformed(ActionEvent e) {
		editorWindow.getXmlTree().expandAll();
	}
